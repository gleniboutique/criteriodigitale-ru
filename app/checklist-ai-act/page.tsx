      ...
      <main className={styles.page} id="top">
        ...
        <section className={`${styles.section} page-shell`} aria-labelledby="route-title">
          <header className={styles.sectionHeader}>
            ...
            <div>
              <p>
                Это русская редакция EU AI Act checklist. Язык документа сам по себе
                не определяет применимость: важны организация, рынок, место использования
                AI-системы и место использования её результата.
              </p>
              <p>
