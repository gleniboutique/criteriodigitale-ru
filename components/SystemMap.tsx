export default function SystemMap() {
  return (
    <figure className="system-atlas">
      ...
      >
        <title id="atlas-title">Карта связей: от ситуации к возможному действию</title>
        <desc id="atlas-description">
          Отправная точка может быть разной: человек без готового проекта, уже работающая система, решение об ИИ или определённое требование. Рассмотрение связей, фактов и ограничений помогает определить подходящее действие. ИИ может быть инструментом работы, но не заменяет человеческого решения.
        </desc>
      ...
      <figcaption>
        <span>Карта отношений / 01</span>
        <span>Ситуация, связи и возможное действие</span>
      </figcaption>
    </figure>
  );
}
