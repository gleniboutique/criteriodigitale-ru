...
В своей работе я называю этот момент **опережающим заполнением вопроса**: чужая, пусть и полезная, логика входит в пространство, где собственная позиция ещё только должна была появиться.
...
Второй — одностороннее описание превращается в якобы объективный вывод. Особенно это заметно в разговорах о сложных отношениях: человек приносит в чат уже отобранные факты, а ответ модели придаёт им форму диагноза или окончательного вердикта.
...
Это не обязательно происходит при каждом использовании AI. Но просьба «сделай проще» не объясняет, **что именно разрешено менять**. Модель вынуждена сама достраивать критерий — и может выбрать не тот.
