...
const steps: Step[] = [
  {
    ...
    what:
      "Два-три разговора или переписка, а между ними я читаю всё: архив, переписки, ответы ваших людей, цифры. Вы рассказываете, что считаете главным, — я проверяю это тем, что у вас лежит.",
    result:
      "На бумаге: что у вас есть, где застревает, чего строить не надо, смета на следующий шаг. Эту бумагу можно отнести кому угодно, не только мне.",
    price: "600 €",
    ...
    <section id="ceny" className="section-spacing bg-paper-2 relative overflow-hidden border-t border-ink/8 scroll-mt-4">
      <div className="page-wide relative">
        ...
        <p className="lead max-w-[640px] mb-12">
          Полчаса, без презентаций и форм. Я задаю вопросы, вы рассказываете;
          я ничего не читала заранее — работаю с тем, что услышала. На выходе:
          вопрос, который стоит за вашим запросом, и честное «стоит ли идти
          дальше — и со мной ли». Иногда этого хватает.
        </p>
